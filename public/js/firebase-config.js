...
// 3. Copy the firebaseConfig object it shows you and replace the
//    values below
// 4. In the console, go to Build > Firestore Database > Create
//    database (choose "Start in test mode" to get going fast,
